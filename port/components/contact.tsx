...
const Contact = (props: SVGProps<SVGSVGElement>) => {
  ...
  return (
    <>
      <div className="mt-20 lg:mt-0 relative z-20 lg:flex-col lg:self-end space-y-6 lg:space-y-0">
        <div className="">
                      ...
                      <Link href={""}>
                        <div className="flex gap-2 items-center">
                          <div className="social-button social-button2">
                            ...
                            >
                              <path
                                  d="M23.994 12.183c0-6.285-5.113-11.398-11.398-11.398s-11.398 5.113-11.398 11.398c0 5.655 4.144 10.329 9.525 11.239v-7.95h-2.864v-3.289h2.864v-2.501c0-2.831 1.68-4.399 4.255-4.399 1.232 0 2.521.22 2.521.22v2.804h-1.42c-1.397 0-1.828.869-1.828 1.76v2.116h3.055l-.488 3.289h-2.567v7.95c5.381-.91 9.525-5.584 9.525-11.239z"/>
                            </svg>
                          </div>
                          <p>Facebook</p>
                        </div>
